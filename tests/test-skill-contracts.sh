...
assert_contains "skills/prd/SKILL.md" '/sdd:review` 的 `doc Reviewer-Subagent` JSON 调用合同'
...
assert_contains "skills/spec/SKILL.md" '/sdd:review` 的 `doc Reviewer-Subagent` JSON 调用合同'
...
assert_contains "skills/plan/SKILL.md" '生成必须使用 `.sdd/templates/plan/template.md`'
assert_contains "skills/plan/SKILL.md" '读取 `.sdd/templates/plan/quality.standard.md`'
assert_contains "skills/plan/SKILL.md" '读取 `.sdd/templates/plan/feasibility.standard.md`'
...
assert_contains "skills/plan/SKILL.md" '/sdd:review` 的 `doc Reviewer-Subagent` JSON 调用合同'
